  ...
  const t: LocaleText = useMemo(() => {
    if (lang === "jp") {
      return {
        ...
        researchTitle: "研究概要",
        researchBody:
          結び目や絡み目に対して定義されるエネルギー汎関数の構造解析、変分公式、ならびにそれに付随する勾配流を研究しています。とくにメビウス・エネルギーを中心に、分解定理を手がかりとして変分構造を精密に解析し、第二変分に現れる「支配的な寄与」や適切な coercivity（強圧性）評価を明らかにすることで、勾配流を偏微分方程式として理解するための枠組みの構築を目指しています。",
        currentThemes: "現在の関心",
        researchSubsections: [
          {
            title: "研究の背景",
